...
namespace ManagementSystem.Repository.Base
{
    public interface IBaseRepository<TEntity> where TEntity : class
    {
        ...
        /// <returns></returns>
        Task<long> Add(TEntity entity, bool isPrimaryKey);
        ...
        /// <returns></returns>
        Task<List<TResult>> Query<TResult>(Expression<Func<TEntity, TResult>> expression, Expression<Func<TEntity, bool>> whereExpression, Expression<Func<TEntity, object>> groupExpression, string orderByFields);
        ...
        /// <returns>值</returns>
        Task<TResult> QueryMuchSingle<T, T2, TResult>(
             Expression<Func<T, T2, object[]>> joinExpression,
             Expression<Func<T, T2, TResult>> selectExpression,
             Expression<Func<T, T2, bool>> whereLambda = null) where T : class, new();
        ...
        /// <param name="whereLambda"></param>
        /// <returns></returns>
        Task<List<TResult>> QueryMuchGroup<T, T2, TResult>(Expression<Func<T, T2, object[]>> joinExpression, Expression<Func<T, T2, TResult>> selectExpression, Expression<Func<T, object>> groupExpression, Expression<Func<T, T2, bool>> whereLambda = null) where T : class, new();
        /// <summary>
        /// 三表联查
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <param name="whereLambda">查询表达式 (w1, w2) =>w1.UserNo == "")</param> 
        /// <returns>值</returns>
        Task<List<TResult>> QueryMuchGroup<T, T2, T3, TResult>(
            Expression<Func<T, T2, T3, object[]>> joinExpression,
            Expression<Func<T, T2, T3, TResult>> selectExpression,
