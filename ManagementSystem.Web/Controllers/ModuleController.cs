    ...
    public class ModuleController : BaseApiController  
    {
       private readonly IModuleServices _moduleServices;
        ...
        public async Task<MessageModel<PageModel<Modules>>> Get(int page = 1, string key = "")
        {
            ...
            Expression<Func<Modules, bool>> whereExpression = a => a.IsDeleted != true ;
            ...
            else
            {
                ...
                int intPageSize = 10;
                data = await _moduleServices.QueryPage(a => a.IsDeleted != true && (a.Name != null && a.Name.Contains(key)), page, intPageSize, " Id desc ");
            }
